...
import ContenedorTarjeta from './components/ContenedorTarjeta';
...
const App = () => {
  ...
  return (
    <>
      ...
      <form>
        <div>
          Negro <input onChange={handleChange} type="checkbox" value="negro" name="color" />
          Blanco <input onChange={handleChange} type="checkbox" value="blanco" name="color" />
          ...
          Rayado <input onChange={handleChange} type="checkbox" value="rayado" name="color" />
        </div>
        <div>
      ...
      <ContenedorTarjeta gatos={gatosFiltrados} />
      <Footer />
    </>
  );
}
